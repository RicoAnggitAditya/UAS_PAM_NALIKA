...
public class DetailOrder extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent != null){
            ...
            ed_nama.setText(intent.getStringExtra("name"));
            ed_alm.setText(intent.getStringExtra("alamat"));
            ed_tlpn.setText(intent.getStringExtra("no_telepon"));
            ed_order.setText(intent.getStringExtra("namaorder"));
        }
    }

    private void saveData(String nama, String alamat, String telpon, String ordername) {
        Map<String,Object> user = new HashMap<>();
        user.put("name", nama);
        user.put("alamat", alamat);
        user.put("no_telepon", telpon);
        user.put("namaorder", ordername);
                    ...
                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()) {
                                Toast.makeText(DetailOrder.this, "Berhasil di Edit", Toast.LENGTH_SHORT).show();
                                finish();
                            } else {
                                Toast.makeText(DetailOrder.this, "Gagal di Edit", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
        }
            ...
            db.collection("users")
                    ...
                    .addOnCompleteListener(new OnCompleteListener<DocumentReference>() {
                        ...
                        public void onComplete(@NonNull Task<DocumentReference> task) {
                            Toast.makeText(DetailOrder.this, "Berhasil di simpan", Toast.LENGTH_SHORT).show();
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(DetailOrder.this, e.getLocalizedMessage(), Toast.LENGTH_SHORT).show();
                            progressDialog.dismiss();
                        }
                    });
        }
